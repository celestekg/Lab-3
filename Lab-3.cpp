//Celeste Going
//Lab 3
/*This program competes against a player in Rock, Paper, Scissors. After the player
chooses either Rock, Paper, or Scissors, the program randomly generates its own choice
that results in a win, loss, or draw for the player.*/
